...
var gulp   = require('gulp'),
    ...
    stylish = require('jshint-stylish');    //引入stylish风格的reporter模块
var jshintConfig = {};
    jshint.lookup = false;
gulp.task('jshint', function() {
  return gulp.src(['src/js/babel.js','src/css/*.css'])
    .pipe(jshint(jshintConfig))
    .pipe(jshint.reporter(stylish)); //stylish风格的reporter打印
    //.pipe(myReporter);  //输出自定义的reporter
});
